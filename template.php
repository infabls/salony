...
<body class="single single-team body_style_wide body_filled article_style_stretch scheme_original top_panel_show top_panel_above sidebar_hide sidebar_outer_hide preloader wpb-js-composer sc_responsive">
            ...
            <div class="top_panel_title_inner top_panel_inner_style_3  title_present_inner breadcrumbs_present_inner">
                <div class="content_wrap">
                    ...
                    <div class="breadcrumbs">
                        ...
                        <a class="breadcrumbs_item cat_post" href="about-us.html">Team Group</a>
                        <span class="breadcrumbs_delimiter"></span>
                        <span class="breadcrumbs_item current">Allan Ryan</span>
                    </div>
                </div>
            </div>
        </div>
...
<h4 class="sc_title sc_title_regular"><?php echo $title; ?></h4>
                                                    <div class="text_column content_element sc_custom_1457948826201">
                                                        <div class="wrapper">
                                                            <p>
		<?php echo $content; ?>
	 </p>
